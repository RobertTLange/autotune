...
Submit the full equal-budget speedrun ablation from the repository root:

```bash
sbatch --export=ALL examples/cifar10_speedrun/run_cifar10_speedrun_ablations.sbatch
```
